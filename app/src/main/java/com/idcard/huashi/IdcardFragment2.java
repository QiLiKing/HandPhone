...
public class IdcardFragment2 extends Fragment {
...
//				Toast.makeText(getActivity(), (String) msg.obj, Toast.LENGTH_SHORT).show();
					toast = Toast.makeText(getActivity(), (String) msg.obj, Toast.LENGTH_LONG);
					toast.show();
					break;
				}
				case SAM_SUCCEED: {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		bt_readidcard.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				bfraw(0);
				objHandler_card.postDelayed(new Runnable() {
